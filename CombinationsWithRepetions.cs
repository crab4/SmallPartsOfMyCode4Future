...
namespace CodeAbbey {
   //Да-да, старая добрая комбинаторика и спустя десять лет продолжает баловать меня
    class Program {
        ...
        /*Если кто-то читает это, то знайте, что я знаю, что я отвратителен и этот код нельзя считать не просто хорошим, а даже нормальным. 
        это есть хучшее, что я мог придумать, но время горело, а голова горела
        Но я настолько заколебался искать адекватный алгоритм, что просто взял, отключил мозг и стал писать код так, как будто он сам идёт из моей головы
         * 
         */
        static void Main() {
         ...
         * а при переносе в код, превратилось в фуфло
         * три страницы вычислений превратились в этот алгоритм, так как я не нашёл ничего удобного в теории, скорее всего плохо искал. прффпфпф Комбинаторика
         * Так по итогу я вывел правильно формулу, но она у меня получилась очень длинной. наткнулся АБСОЛЮТНО СЛУЧАЙНО МАТЬ ПЕРЕМАТЬ на рекурсивное решение
         * Не сразу понял, что это относится к моей задаче. Комбинаторика была на втором курсе, а мне уже тридцатник. Не помню ничего.
        ...
        //Изначально функция была итеративной и прямо таки отвратительной, всё херово у меня с рекурсией, не всегда придумываю, как её можно использовать, чтобы упрастить код
