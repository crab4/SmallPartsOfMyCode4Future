...
namespace RSA_Crypto {
    class RSACryptoFunc {
        ...
        //Ха.Ха-ха.Хахахахаха. Думал обойдётся без возведений в степень через двоичную степень? Ну уж нетушки(+_)+). Более того, не просто так е = 65537, так как там всего две 
